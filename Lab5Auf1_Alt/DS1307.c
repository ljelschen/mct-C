...
void DS1307StartOsc(void) {
	...
	TWIWrite((uint8_t)(0x0E)); // Seconds register
...
void DS1307SetTimeAndDate(uint8_t h, uint8_t m, uint8_t s, uint8_t dayOfWeek, uint8_t date, uint8_t month, unsigned int year) {
